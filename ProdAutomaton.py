class ProdAutomaton:
    ...
    def get_transition(self, curr_state, ContextState, control_idx):
        ...
        **Cache Management**: Only keeps 50,000 most recent queries. Older entries
        ...
        # Get successors from inverse map (memory-efficient approach)
        successor_states = self.SymbolicAbstraction.get_successors(sys_state, control_idx)
        
        all_transition = []
        for next_sys_state in successor_states:
